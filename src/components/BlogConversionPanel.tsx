...
const BlogConversionPanel = ({
  ...
  return (
    <section className="space-y-5">
      <div className="rounded-lg border border-border bg-gradient-to-br from-primary/10 via-background to-burgundy/10 p-6 sm:p-8">
      ...
      <SponsorPlacement placement="blog" variant="compact" title="Recommended resource" />
    </section>
  );
};
