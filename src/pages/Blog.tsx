  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 pt-32 pb-16">
        ...
        {/* Article - Exercise and Nutrition in Recovery */}
        <article className="max-w-3xl mx-auto mb-20">
          <img 
            src={blogImageExerciseNutrition} 
            alt="Person jogging at sunrise on nature trail with healthy food and water bottle" 
          ...
          <p className="text-muted-foreground text-sm mb-8">December 11, 2025</p>
