...
const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    imageAlt: "Young adult male sitting at kitchen table looking emotionally flat with a translucent ghostly overlay of his younger happier self behind him, family photos on wall fading from vibrant to muted",
    excerpt: "When addiction drags on long enough, families start rewriting history. \"They've always had a temper.\" \"They've never been responsible.\" \"They were always secretive.\" The longer the pattern persists, the easier it becomes to believe this is just who they are. But addiction alters behavior gradually. Over time, repeated exposure makes change feel permanent. Assuming \"they've always been this way\" can prevent families from recognizing what addiction has actually reshaped.",
    content: (
      <div className="prose prose-lg max-w-none text-foreground/90 space-y-6">
        <p>
  ...
  },
  {
    ...
    imageAlt: "Young adult male sitting alone at a bar counter with his head in his hands next to a glass of whiskey, with the word STRESS as a shadow on the wall behind him, symbolizing stress as a cover for addiction",
    excerpt: "If you've lived around addiction long enough, you've probably heard it: \"They're just stressed.\" Work stress. Financial stress. Relationship stress. Stress becomes the universal explanation for mood swings, irritability, secrecy, and escalating substance use. The problem? Stress is real—but it's often not the whole story. When stress becomes the default excuse, addiction hides comfortably behind it.",
    content: (
      <div className="prose prose-lg max-w-none text-foreground/90 space-y-6">
        <p>
