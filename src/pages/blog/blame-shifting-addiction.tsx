  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="You try to talk about the drinking. You stay calm. You stick to facts. And somehow, twenty minutes later, you're defending yourself. Understanding blame shifting and emotional deflection helps families stay grounded instead of getting pulled into endless arguments."
        canonical="/blog/blame-shifting-addiction"
        ogType="article"
        ogImage={blogImageBlameShifting}
        keywords="addiction, blame shifting, family support, enabling, boundaries, communication"
